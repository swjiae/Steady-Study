...
- 이은혁 : 토이 프로젝트 crud 기능 구현하기
- 고영석 : 1일 1알고+블로그 작성, 진도 따라가기, sqld 조금씩 공부하기, 
- 김지애 : 수업진도 따라가기, cs db 공부하기
- 김지오 : 1일 1 알고리즘 풀기 (재귀랑 dfs bfs), 수업진도 따라가기, 쟝고 복습하고 노션or 블로그에 정리
- 나혜승 : 자바스크립트 노션에 정리, api 세번 반복하기
- 이수연 : 점프 투 자바 끝내기, 1일 1알고리즘 문제풀이(요일별로 다른 알고리즘 분류 / pass 못해도 시도하기), 수업 진도 따라가기
- 이문삼 : 수업 진도 따라가기, CS 블로그에 포스팅하기, 자바스크립트로 알고리즘 풀기
- 정혜수 : 
- 김준영 : 
