...
### 주간 목표 및 달성률(2022.09.25 ~ 2022.10.01)

- 이은혁 : :white_check_mark: ~~백준 1일 1문제씩 풀기, Velog 7개 글 올리기, 체중 62kg대 초중반 진입하기~~
- 고영석 : :white_check_mark: ~~월말평가 통과하기, 백준 IM 대비 문제 풀기, 블로그 3개 이상 작성하기~~
- 김지애 : :white_check_mark: ~~알고리즘 과제 전풀완, velog 개설하기+1개 작성하기, 운동 2회~~
- 김지오 : :white_check_mark: ~~백준 IM 대비 문제 매일 2개씩 풀기, 블로그 글 30개 넘게, 알고리즘 진도 따라가기 (현재를 살자)~~
- 나혜승 : :white_check_mark: ~~알고리즘 매일 2개씩 풀기, 문제 푼 것들 깃에 커밋하기, 알고리즘 수업 이해하기~~
- 이수연 : :white_check_mark: ~~블로그 글 7개 이상 쓰기, 깃허브 주 7회 올리기~~
- 이문삼 : :white_check_mark: ~~블로그 글 30개 넘기기, 자바스크립트 강의 듣기(제발)~~
