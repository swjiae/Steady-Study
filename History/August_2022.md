...
### 주간 목표 및 달성률(2022.08.28 ~ 2022.09.03)

- 이은혁 : :white_check_mark: ~~자바 강의 완강하고 노션 정리하기~~
- 고영석 : :white_check_mark: ~~IM 시험 대비하기 + django 나가는 동안 밀린 알고리즘 풀기 +~~
- 김지애 : :white_check_mark: ~~django 노션 정리하기, 밀린 알고리즘 과제 완료하기, cs공부 틀잡기~~
- 김지오 : :white_check_mark: ~~구글 시트 week 1, week3 다 풀고 노션에 정리하기. 운동 주 3회 이상 하기. 9월 채용공고 훑고 지원할거 따로 정리해두기.~~
- 나혜승 : :white_check_mark: ~~IM 시험준비 알고 1일 1알고리즘 풀기, Django 복습하기.~~
- 이수연 : :white_check_mark: ~~큐 알고리즘 4 문제 풀기, 블로그 게시글 10개 올리기~~
- 이문삼 : :white_check_mark: ~~브라우저 WEB APIS, 브라우저 DOM, 자바스크립트 이벤트 강의 듣고 블로그에 정리해서 올리기~~
